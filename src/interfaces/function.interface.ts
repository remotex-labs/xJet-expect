 ...
 *
 * @template T - The type of object that will be constructed, defaults to object
 * @since 1.0.0
 */
 ...
 * If a property of `T` is itself an object, this type will also apply the `PartialDeepType` transformation to the nested object.
 *
