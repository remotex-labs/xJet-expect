...
describe('isA function', () => {
    ...
    test('should handle inheritance correctly', () => {
        ...
        expect(isA(Animal, dog)).toBe(false); // Note: this is false because dog.constructor is Dog, not Animal
    });
});
...
describe('hasKey function', () => {
    ...
    test('should return false for non-existent properties', () => {
        ...
        expect(hasKey(obj, 'toString')).toBe(false); // Inherited property
    });
