...
describe('diffComponent', () => {
    ...
    test('should display type differences when types are different', () => {
        ...
        expect(EXPECTED).toHaveBeenCalledWith('Expected type: ');
        expect(MARK).toHaveBeenCalledWith('number');
        expect(RECEIVED).toHaveBeenCalledWith('Received type: ');
    ...
    test('should handle same-type but complex differences', () => {
        ...
        expect(EXPECTED).not.toHaveBeenCalledWith('Expected type: ');
        expect(MARK).not.toHaveBeenCalledWith('Object');
    ...
    test('should handle null and undefined values', () => {
        ...
        expect(RECEIVED).toHaveBeenCalledWith('Received type: ');
        expect(MARK).toHaveBeenCalledWith('undefined');
    });
