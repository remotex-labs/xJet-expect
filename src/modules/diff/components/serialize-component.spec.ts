...
import { appendLines, serialize, serializeArray } from '@diff/components/serialize.component';
import { serializeBuffer, serializeMap, serializeMapKey, serializeObject } from '@diff/components/serialize.component';
import { serializePrimitive, serializeSet, serializeTypedArray, serializeValue } from '@diff/components/serialize.component';
...
describe('serializePrimitive', () => {
    ...
    test('serializes non-finite numbers correctly', () => {
        ...
        expect(serializePrimitive(Infinity)).toBe('NaN');
        expect(serializePrimitive(-Infinity)).toBe('NaN');
    });
    ...
    test('serializes bigints correctly', () => {
...
describe('serializeMap', () => {
    ...
    test('uses provided custom indent', () => {
        ...
        serializeMap(map, lines, customIndent);
...
describe('serializeArray', () => {
    ...
    test('handles empty array correctly', () => {
        ...
        serializeArray(arr, lines, INDENT);

        expect(lines).toEqual([ 'Array []' ]);
    });
    ...
    test('uses provided custom indent', () => {
        ...
        serializeArray(arr, lines, customIndent);
...
describe('serializeSet', () => {
    ...
    test('uses provided custom indent', () => {
        ...
        serializeSet(set, lines, customIndent);
...
describe('serializeBuffer', () => {
    ...
    test('handles large buffer with many values', () => {
        ...
        // Verify last value doesn't have a comma
...
describe('serializeObject', () => {
    ...
    test('handles empty object correctly', () => {
        ...
        serializeObject(obj, lines, INDENT);
    ...
    test('uses constructor name for custom classes', () => {
        ...
        serializeObject(person, lines, INDENT);
    ...
    test('uses provided custom indent', () => {
        ...
        serializeObject(obj, lines, customIndent);
    ...
    test('serializes objects with mixed property types', () => {
        ...
        expect(lines.find(line => line.includes('array: Array ['))).toBeTruthy();
...
describe('serializeValue', () => {
    ...
    test('serializes DataView correctly', () => {
        ...
        serializeValue(view, lines, INDENT);
    ...
    test('serializes primitive string', () => {
        ...
        serializeValue(value, lines, INDENT);
...
describe('serialize', () => {
    ...
    test('returns array of lines for complex nested structure', () => {
        ...
        // Check for presence of different types in the output
